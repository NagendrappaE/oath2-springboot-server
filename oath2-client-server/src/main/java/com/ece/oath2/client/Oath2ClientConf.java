...
public class Oath2ClientConf {
	...
	public RestTemplate restTemplate() throws KeyManagementException, NoSuchAlgorithmException, KeyStoreException,
			CertificateException, MalformedURLException, IOException, java.security.cert.CertificateException, UnrecoverableKeyException {

		KeyStore keyStore = KeyStore.getInstance("PKCS12");
	    try (FileInputStream fis = new FileInputStream("/home/nagendrappae/Documents/openFinance/altareqKeystore.jks")) {
	        keyStore.load(fis, "Flux@123".toCharArray());
	    }
	    
		SSLContext sslContext = new SSLContextBuilder()
				.loadTrustMaterial(trustStore.getURL(), trustStorePassword.toCharArray())
				.loadKeyMaterial(keyStore, "Flux@123".toCharArray())
				.build();
